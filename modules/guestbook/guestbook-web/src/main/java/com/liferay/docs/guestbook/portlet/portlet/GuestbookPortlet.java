...
public class GuestbookPortlet extends MVCPortlet {
	...
	public void addEntry(ActionRequest request, ActionResponse response) {
		try {
			final ServiceContext serviceContext = ServiceContextFactory.getInstance(Entry.class.getName(), request);

			final String userName = ParamUtil.getString(request, "name");
			final String email = ParamUtil.getString(request, "email");
			final String message = ParamUtil.getString(request, "message");
			final long guestbookId = ParamUtil.getLong(request, "guestbookId");
			final long entryId = ParamUtil.getLong(request, "entryId");
